...
import { Newspaper, Star, Heart } from 'lucide-react';
          ...
          <ScrollAnimation>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Latest updates from the wizarding world
              </p>
            </div>
          </ScrollAnimation>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ScrollAnimation delay={0.1}>
              <motion.div className="bg-black/40 backdrop-blur-md rounded-lg p-6 border border-yellow-500/20">
                <Newspaper className="h-12 w-12 text-blue-400 mb-4" />
                <h3 className="text-xl font-bold text-white mb-2">Latest News</h3>
                <p className="text-gray-300">Stay updated with magical happenings.</p>
              </motion.div>
            </ScrollAnimation>
            ...
            <ScrollAnimation delay={0.2}>
              <motion.div className="bg-black/40 backdrop-blur-md rounded-lg p-6 border border-yellow-500/20">
                ...
                <p className="text-gray-300">Upcoming magical events and celebrations.</p>
              </motion.div>
            </ScrollAnimation>
            ...
            <ScrollAnimation delay={0.3}>
              <motion.div className="bg-black/40 backdrop-blur-md rounded-lg p-6 border border-yellow-500/20">
                ...
                <p className="text-gray-300">Fan community highlights and stories.</p>
              </motion.div>
            </ScrollAnimation>
          </div>
        </div>
